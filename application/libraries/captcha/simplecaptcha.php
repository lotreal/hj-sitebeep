 ...
 *
 * 在CI模板页调用 
 * <img src="<?php echo site_url('welcome/captcha');?>" onclick="javascript:this.src = '<?php echo site_url('welcome/captcha');?>?t='+ Math.random()" title="点击更换验证码"/>
 *
 */
class SimpleCaptcha {
    ...
    public $fonts = array(
        ...
        'Duality'  => array('spacing' => -2, 'minSize' => 10, 'maxSize' => 28, 'font' => 'Duality.ttf'),
        ...
        'VeraSans' => array('spacing' => -1, 'minSize' => 10, 'maxSize' => 28, 'font' => 'VeraSansBold.ttf'),
    );
    ...
    public function __construct($config = array()) {
    	...
    	$this->resourcesPath = dirname(__FILE__).DIRECTORY_SEPARATOR.'resources';
    }
    ...
    function GetDictionaryCaptchaText($extended = false) {
        ...
        substr($text,0,mt_rand($this->minWordLength, $this->maxWordLength));
    }
