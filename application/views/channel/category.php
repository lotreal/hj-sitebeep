...
<div class="container mod_list">
  <form name="myform" id="myform" action="" method="get">
    <div class="operation"><span class="right">
      ...
      <a href="<?php echo site_url('channel/cat_add');?>" title="添加新分类" class="add_btn colorbox">添加</a>
    </div>
    <table class="showlist">
      <thead>
        <tr>
          <th class="w50"><a href="javascript:void(0)" id="checkall" title="全选/不选">选择</a></th>
          <th class="wauto">渠道分类</th>
          <th class="w8">显示排序</th>
          <th class="w8">操作人员</th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="<?php echo site_url('channel/cat_update/'.$v['cat_id']);?>" title="修改" class="colorbox">修改</a> <a href="<?php echo site_url('channel/cat_verify/'.$v['cat_id'].'/'.$v['status']);;?>" title="审核" class="confirm">审核</a> <a href="<?php echo site_url('channel/cat_delete/'.$v['cat_id']);;?>" title="删除" class="confirm">删除</a></td>
        </tr>
        <?php endforeach;?>
		<?php else:?>
		<tr>
